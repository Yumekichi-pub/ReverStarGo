/* ============================================================
   ...
   - perfect : 上記 + 敗者の合計石数 = 0 (取られた石も0)
              → 「Perfect! 🎉/Total Conquest! 🎉」+ 花火 + ファンファーレ
   - dominant: 上記 + 敗者の合計石数 > 0
              → 「Board Sweep!/All ◯ Conquest!」+ 紙吹雪 + 拍手音
...
const PERFECT_MESSAGES = ['Perfect! 🎉', 'Total Conquest! 🎉'];
...
function pickDominantMessage(winnerColor) {
  // 勝者の色に応じて「All Black／All White」を切り替え
  const colorWord = winnerColor === 'black' ? 'All Black' : 'All White';
  const messages = ['Board Sweep!', `${colorWord} Conquest!`];
